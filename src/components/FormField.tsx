    ...
    <div className={`space-y-1 ${className}`}>
      ...
      <div className="relative">
        ...
        <input
          ...
          required={required}
          className={`w-full h-[44px] ${icon ? "pl-11" : "pl-4"} pr-12 bg-surface-container-lowest dark:bg-[#14161f] border border-outline-variant rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all text-on-surface dark:text-white placeholder:text-outline/60`}
        />
        {isPassword && (
          <button
            type="button"
